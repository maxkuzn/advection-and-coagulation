...
func (c *sequentialCoagulator) processCell(cell, buff cell.Cell, sizes []float64) {
	for i := range cell {
...
func (c *sequentialCoagulator) processSizeHalf(cell cell.Cell, sizes []float64, index int) cell.FloatType {
...
func (c *sequentialCoagulator) processSizeFull(cell cell.Cell, sizes []float64, index int) cell.FloatType {
	L1 := c.computeL1(cell, sizes, index)
	L2 := c.computeL2(cell, sizes, index)
	currValue := cell[index]
...
func (c *sequentialCoagulator) computeL1(cel cell.Cell, sizes []float64, index int) cell.FloatType {
	if index == 0 {
		return 0
	}
...
func (c *sequentialCoagulator) computeL2(cel cell.Cell, sizes []float64, index int) cell.FloatType {
	if index == 0 {
		return 0
	}
