...
func (c *Coagulator) processCell(cell, buff cell.Cell) {
	for i := range cell {
...
func (c *Coagulator) processSizeHalf(cell cell.Cell, index int) cell.FloatType {
...
func (c *Coagulator) processSizeFull(cell cell.Cell, index int) cell.FloatType {
	L1 := c.computeL1(cell, index)
	L2 := c.computeL2(cell, index)
	currValue := cell[index]
...
func (c *Coagulator) computeL1(cel cell.Cell, index int) cell.FloatType {
	if index == 0 {
		return 0
	}
...
func (c *Coagulator) computeL2(cel cell.Cell, index int) cell.FloatType {
	if index == 0 {
		return 0
	}
